      ...
      <div className="grow flex items-center justify-center p-6 bg-[radial-gradient(circle_at_bottom_left,rgba(124,58,237,0.1),transparent_50%)]">
        <div className="w-full max-w-md space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
          <div className="text-center">
            ...
            <h1 className="font-serif text-4xl font-medium tracking-tight text-white">Create Account</h1>
            <p className="mt-2 text-zinc-500">Join thousands of job seekers using AI.</p>
          </div>
          ...
          <div className="glass-card rounded-3xl p-8 border border-zinc-800/50 shadow-2xl space-y-6">
            <div className="space-y-4">
              <button 
                ...
                className="w-full h-14 rounded-xl bg-white text-zinc-950 font-bold hover:bg-zinc-200 transition-all flex items-center justify-center gap-4 group shadow-xl"
              >
            ...
            <p className="text-center text-[10px] text-zinc-500 uppercase tracking-widest leading-relaxed">
                Fast, secure, and password-free. <br/>
