...
search_terms = ["AL/ML Engineer", "Deep Learning Engineer", "Machine Learning Engineer", "Software Developer", "Full Stack Developer", "Backend Developer", "Frontend Developer", "Nodejs Developer", "Software Engineer", "Python Developer", "React Developer"]
...
bad_words = ["Crossover"]                     # (dynamic multiple search) or leave empty as []. Case Insensitive. Ex: ["word_1", "phrase 1", "word word", "polygraph", "US Citizenship", "Security Clearance"]
