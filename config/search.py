...
search_terms = ["Software Developer", "Full Stack Developer", "Backend Developer", "Frontend Developer", "Nodejs Developer", "Software Engineer", "Python Developer", "React Developer"]
...
about_company_bad_words = ["Crossover", "Epic", "Staffing", "Recruiting"]       # (dynamic multiple search) or leave empty as []. Ex: ["Staffing", "Recruiting", "Name of Company you don't want to apply to"]
...
bad_words = ["Crossover", "Sales", "Marketing", "BPO", "Voice Process"]                     # (dynamic multiple search) or leave empty as []. Case Insensitive. Ex: ["word_1", "phrase 1", "word word", "polygraph", "US Citizenship", "Security Clearance"]
