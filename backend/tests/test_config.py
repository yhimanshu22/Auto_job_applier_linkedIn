...
TEST_USER = "config-test@example.com"


def test_get_config_personals(client, auth_as):
    auth_as(TEST_USER)
...
def test_save_config_invalid_category(client, auth_as):
    auth_as(TEST_USER)
...
def test_save_and_read_config(client, auth_as):
    auth_as(TEST_USER)
...
def test_save_list_config(client, auth_as):
    auth_as(TEST_USER)
