...
class EngageContext:
    ...
    actions_done: int = 0
    page_scrolls: int = 0
    # Consecutive empty viewports (``_find_visible_posts`` returns []).
    # Engage aborts once this exceeds a small threshold so a broken / empty
    # feed (typically caused by headless detection) doesn't waste minutes.
